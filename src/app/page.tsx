...
async function HomePage() {
  ...
  return (
    <section className="p-8">
      <h1 className="backgroundCover textCenter font-mont mb-5">Food<span className="span">Go</span></h1>
        ...
        {session ? (
          <>
            <section className="text-center p-8">
              ...
              <Link href="/registerProduct" className="buttonCustom2 block py-2 pl-3 pr-4 text-white rounded">Registrar Turno</Link>
